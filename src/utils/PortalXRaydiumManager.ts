...
export class PortalXRaydiumManager {
  ...
  constructor(client: PortalXBlockchainClient, tokenMint: string) {
    ...
    if (this.RAYDIUM_PROGRAM_ID.toString() === '675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8') {
      console.log('Using Raydium devnet program ID - Replace with mainnet ID for production');
    }
  }
